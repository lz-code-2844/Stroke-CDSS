...
**急性缺血性卒中临床决策支持系统** (Acute Ischemic Stroke Clinical Decision Support System)
...
```bash
pip install pandas openpyxl openai numpy scikit-learn sentence-transformers
```
...
| 方案 | 说明 | 适用场景 |
|-----|------|---------|
| **A** | 单纯静脉溶栓 (IVT) | 4.5h内，无LVO或不符合取栓指征 |
| **B** | 血管内取栓 (EVT) | 有LVO且符合取栓指征，可桥接或单纯取栓 |
...
@software{stroke_cdss_2024,
  ...
  author = {Your Name},
  year = {2024},
  url = {https://github.com/yourusername/stroke-cdss}
}
```
